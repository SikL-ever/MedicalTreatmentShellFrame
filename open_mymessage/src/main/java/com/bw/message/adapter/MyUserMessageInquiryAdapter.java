...
public class MyUserMessageInquiryAdapter extends RecyclerView.Adapter<MyUserMessageInquiryAdapter.ViewHolder> {
    private Context context;

    public MyUserMessageInquiryAdapter(Context context) {
    ...
    @NonNull
    @Override
    public MyUserMessageInquiryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyUserMessageInquiryAdapter.ViewHolder holder, int position) {
