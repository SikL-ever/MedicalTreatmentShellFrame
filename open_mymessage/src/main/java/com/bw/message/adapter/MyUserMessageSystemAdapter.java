...
public class MyUserMessageSystemAdapter extends RecyclerView.Adapter<MyUserMessageSystemAdapter.ViewHolder> {
    private Context context;

    public MyUserMessageSystemAdapter(Context context) {
    ...
    @NonNull
    @Override
    public MyUserMessageSystemAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyUserMessageSystemAdapter.ViewHolder holder, int position) {
