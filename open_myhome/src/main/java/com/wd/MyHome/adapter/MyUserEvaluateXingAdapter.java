...
public class MyUserEvaluateXingAdapter extends RecyclerView.Adapter<MyUserEvaluateXingAdapter.ViewHolder> {

    private Context context;

    public MyUserEvaluateXingAdapter(Context context) {
        this.context = context;
    }

    @NonNull
    @Override
    public MyUserEvaluateXingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = View.inflate(context, R.layout.myuserevaluate_adapter, null);
        return new ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull final MyUserEvaluateXingAdapter.ViewHolder holder, int position) {
